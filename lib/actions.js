...
exports.init = function (target, options, defaults) {
...
exports.deploy = function (target, options, defaults) {
  ...
  promptForTarget(target, options.directory, function (err, targetPath) {
    ...
    config.load(targetPath, function (settings) {
      ...
      promptForPassword(settings.sshAddress, function (password) {
        ...
        deploy(settings, options.sshIdentityFile);
...
exports.remove = function (target, options, defaults) {
  target = target || defaults.defaultTarget;
  ...
  promptForTarget(target, options.directory, function (err, targetPath) {
    ...
    config.load(targetPath, function (settings) {
      ...
      promptForPassword(settings.sshAddress, function (password) {
        ...
        remove(settings, options.sshIdentityFile);
      });
    });
  });
};
...
function overrideSshUser(user, address) {
